...
# plot fit line(straight line)(orign fit line)
plt.plot(logP2, fit_line2, label="best Fit of d(Mpc) VS logP ", color= "red")
# plot fit line(straight line)(better fit line)
plt.plot(logP2, fit_line2_new, label="best Fit of d(Mpc) VS logP(better fit line)", color= "green")
# plot description bar on the top right, says what is 
plt.legend()
# background lines(grids)
plt.grid()
...
plt.hist(d_Mpc, bins= 60, density=True, alpha=0.6, color='blue', label='Simulated d Distribution')
